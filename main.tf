...
resource "aws_instance" "Pagos_dev_instance" {
    ...
    key_name = "vockey" # Nombre de tu key pair existente en AWS
        ...
        vpc_security_group_ids = vpc_security_group_ids = data.aws_security_group.existing != null ? [data.aws_security_group.existing.id] : [aws_security_group.instance_security_group.id]
        tags = {
