...
resource "aws_instance" "Pagos_qa_instance" {
    ...
    vpc_security_group_ids = data.aws_security_group.existing != null ? [data.aws_security_group.existing.id] : [aws_security_group.instance_security_group[count.index].id]
